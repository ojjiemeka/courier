            ...
            <div class="col-md-12 col-lg-4 dash bod">
                <div class="card">
                    ...
                    <div class="card-body bod">
                        ...
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" style="width: {{ $track2->progress }}%" aria-valuenow="{{ $track2->progress }}" aria-valuemin="0" aria-valuemax="100">{{ $track2->progress }}</div>
                          </div>
                        @endforeach
                    </div>
                </div>
